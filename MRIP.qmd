...
matplot(rownames(dis), cbind(dis[, , 1], dis[, , 2]), lty = c(rep(2, 4), rep(1, 4)), col = rep(1:4, 2), 
        type = "l", lwd = 2, xlab = "year", ylab = "proportion dolphin discarded", ylim = c(0, 0.5))
...
write.csv(findat, file = "data/MRIP_catch_by_season_4_areas.csv", append = F, row.names = FALSE, col.names = TRUE)
```
