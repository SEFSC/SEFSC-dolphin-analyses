...
f   # table with catches separated by wave and year
f[is.na(f)] <- 0
...
pre_colsum == pos_colsum  # check that catch was parsed correctly - column sums should be identical 
...
table(f$seas)
f$seas1 <- NA
f$seas1[which(f$seas == "(0,1.5]")] <- "DJF"  # DJF is 0.5 and 1
f$seas1[which(f$seas == "(1.5,3]")] <- "MAM"  # MAM is 2 and 2.5
f$seas1[which(f$seas == "(3,4.5]")] <- "JJA"  # JJA is 3.5 and 4
f$seas1[which(f$seas == "(4.5,6]")] <- "SON"  # SON is 5 and 5.5
