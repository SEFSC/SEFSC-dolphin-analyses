...
## Download FAO data and summarize
...
df <- read.csv("data/FAO_dolphin_data.csv")  # open the FAO data file
head(df)
...
## Create a new maximum landings scenario dataset
