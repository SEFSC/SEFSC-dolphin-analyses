...
matplot(yrs, cbind(old, new), xlab = "", lty = 1, col = c(2, 4), type = "b", pch = 19, 
        ...
        main = "Comparison of FOSS data with corrected split by Monroe County")
...
hist((old - new)/old*100, main = "Percent difference from FOSS data", breaks = 10, 
...
We replace the FOSS values for Gulf and South Atlantic recreational catches with these new values and replot the full data set. We can also plot the landings as a line graph so that the relative magnitudes of catch across region and sector are more easily compared.
...
matplot(yrs, datnew/10^6, col = c(4, 4, 2, 2, 3, 3, 1, 1), lty = c(1, 3, 1, 3, 1, 3, 1, 3), type = "l",
             las = 2, ylab = "total landings (millions of pounds)", lwd = 2, 
             main = "Dolphin landings in the U.S. EEZ -- correct Monroe County split")
